...
static void usage(const char *progname)
{
	...
	printf("\nExample:\n");
	printf("  sudo ./tstools_smpte2038_inspector -i eno2 -F 'host 227.1.20.80 && udp port 4001'  -- auto-detect SCTE/video pids from nic\n");
	printf("       ./tstools_smpte2038_inspector -i recording.ts                                 -- auto-detect SCTE/video pids from file\n");
	printf("       ./tstools_smpte2038_inspector -i recording.ts -P 0x67                         -- Disable auto-detect force decode of pid 0x67\n");
	printf("       ./tstools_smpte2038_inspector -i udp://227.1.20.80:4001                       -- auto-detect SCTE/video pids from socket/stream\n");
}
