...
void output_free(struct tool_ctx_s *ctx, struct output_stream_s *os)
{
...
int output_write(struct tool_ctx_s *ctx, struct output_stream_s *os, uint8_t *pkt, int byteCount)
{
